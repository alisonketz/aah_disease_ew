...
county_deer_habitat <- terra::crop(deer_habitat,county)
...
study_deer_hab <- mask(study_deer_habitat,study_df)
plot(study_deer_hab)



sum(!is.finite(values(county_deer_habitat)))
length(values(county_deer_habitat))


sum(!is.finite(values(study_deer_habitat)))
length(values(study_deer_habitat))


plot(county_deer_habitat)
plot(study_deer_habitat)

names(county_deer_habitat)
res(county_deer_habitat)

ggplot()+geom_spatraster(data=deer_habitat)
